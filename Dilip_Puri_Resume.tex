...
\vspace*{.051mm}
\hspace*{2.6mm} In this project we created OCR services to extract the meaningful data from scanned image of Aadhaar-Card, Bank Cheque. We extracted meaningful data like Name, Date of birth, Aadhaar-Card No., Bank Name, Cheque no., Address, etc. Accuracy of extracted data was around 80-85$\%.$% In this project we used OpenCV for image processing and python-tesseract library for text extraction from image.
